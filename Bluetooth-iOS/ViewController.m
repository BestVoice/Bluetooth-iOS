...
//  Bluetooth-iOS
//
//  Created by 李志强 on 17/6/21.
//  Copyright © 2017年 Voice. All rights reserved.
//

#import "ViewController.h"
#import <CoreBluetooth/CoreBluetooth.h>

#define kServiceUUID @"b62c4e8d-62cc-404b-bbbf-bf3e3bbb1374" //服务的UUID
#define kCharacteristicUUID @"b62c4e8d-62cc-404b-bbbf-bf3e3bbb1374" //特征的UUID
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error
{
    ...
    if ([characteristic.UUID  isEqual: kCharacteristicUUID]) {
        ...
        //给外设设备写入数据。第一个参数是已连接的蓝牙设备 ；第二个参数是要写入到哪个特征； 第三个参数是通过此响应记录是否成功写入
